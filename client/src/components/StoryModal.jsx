...
const StoryModal = ({setShowModal, fetchStories}) => {
  ...
  const bgColors = ['#000000ff', '#FFD700', '#f61e8aff', '#c190efff', '#00a0d1ff', '#57a757ff', '#ff0000ff']
  ...
  return (
    <div className='fixed inset-0 z-110 min-h-screen bg-black/80 backdrop-blur text-white flex items-center justify-center p-4'>
      <div className='w-full max-w-md'>
        ...
        <div className='rounded-lg h-96 flex items-center justify-center relative' style={{backgroundColor: background}}>
          ...
          )}
          {
            mode === 'media' && previewUrl && (
              media?.type.startsWith('image/') ? (<img src={previewUrl} alt="" className='object-contain max-h-full'/>
              ) : (
        ...
        })} className='w-full bg-white text-white py-3 mt-4 w-full rounded bg-gradient-to-r from-indigo-500 to-purple-600 hover:from-indigo-600 hover:to-purple-700 active:scale-95 transition cursor-pointer flex items-center justify-center gap-2'>
