        ...
        <div className='bg-white rounded-lg shadow p-6'>
          ...
          <form className='space-y-4' onSubmit={handleSaveProfile}>
            ...
            <div className='flex flex-col items-start gap-3'>
                <label htmlFor="cover_photo" className='block text-sm font-medium text-gray-700 mb-1'>
                    ...
                    <div className='group/cover relative'>
                        <img src={editForm.cover_photo ? URL.createObjectURL(editForm.cover_photo) : user.cover_photo} className='e-80 h-40 rounded-lg bg-gradient-to-r from-indigo-200 via-purple-200 to-pink-200 object-cover mt-2' alt="" />
            ...
            <div>
                ...
                <textarea rows={3} className='w-full p-3 border border-gray-200 rounded-lg' placeholder='Add bio' onChange={(e)=>setEditForm({...editForm, bio: e.target.value})} value={editForm.bio}/>
            </div>
